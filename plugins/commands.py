...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
              [
                  InlineKeyboardButton(f'Movies ᴜᴘᴅᴀᴛᴇs​', url='https://t.me/TeluguCinematic_universe'),
                  InlineKeyboardButton(f'ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ', url='https://t.me/TeluguCinematic_universe'),
                  InlineKeyboardButton('Otts At Cheaper Prices', url='https://t.me/MMNOTTMARTZ')
         ]
            ]
